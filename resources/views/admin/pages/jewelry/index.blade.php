...
@section('page-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col-lg-12 d-flex justify-content-around align-content-center">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span>List of Products</h4>
            <div class="">
                <a href="{{ route('create.products') }}" class="btn btn-success">Add Products</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($record as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('create.products', $data['id']) }}" class="me-3"><i
                                                        class='bx bx-edit-alt'></i></a>
                                                <a href="{{ route('delete.products', $data['id']) }}" class="me-3">
